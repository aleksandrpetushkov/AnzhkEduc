...
namespace callBackTst
{
	internal class Program
	{
		public static void Main(string[] args)
		{
			...
			List<int[]> kk = new List<int[]>(1000000);
			List<int[]> nw = new List<int[]>(1000000);
			List<int[]> nw2 = new List<int[]>(1000000);
			List<Smfn> z0 = new List<Smfn>(1000000);
			List<Smfn> z1 = new List<Smfn>(1000000);
			Stopwatch sw = new Stopwatch();
			sw.Start();
			foreach(int[] elm in lst)
			{
				Smfn s = new Smfn(elm, nw);
				//zz.Add(s);
			}
			sw.Stop();
