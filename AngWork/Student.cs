...
namespace AngWork
{
    ...
    public class Student : AAlive
    {
        ...
        //Studen - конструктор класса 
        //При обявлении конструктора с какими-либо параметрами - конструктор по умолчанию не доступен, если он требуется, его нужно явно создать
        //*
        ...
        // static - поле/метод пренадлежит классу, а не объекту и является общим для всех объектов, нельзя обратиться через объект, только через класс.
